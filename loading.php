...
<head>
    ...
    <title>Loading...</title>
    <link rel="stylesheet" href="partials/loading.css">
    <script>
    // document.getElementById("pid").innerHTML = window.params.user;
    ...
    function myURL() {
        document.location.href = 'result.php?pid=' + <?php echo $_GET['pid']?>;
    }
    </script>
</head>
